...
export enum MagproxyErrorsResponseEnum {
  ...
  RFO_UNEXPECTED_RESPONSE = 'There is problem with unexpected registry response. More details in app logs.',
  RPO_UNEXPECTED_RESPONSE = 'There is problem with unexpected registry response. More details in app logs.',
