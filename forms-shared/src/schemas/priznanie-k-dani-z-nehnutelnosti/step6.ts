...
const podielPriestoruNaSpolocnychCastiachAZariadeniachDomu = (typ: Typ) =>
  input(
    ...
    },
    {
      ...
      helptextFooter:
        typ === Typ.Byt
          ? 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o vchode, poschodí a čísle bytu. :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/6_byt_podiel_priestoru_265f9a3965.png"}'
          : 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o vchode, poschodí a čísle priestoru. :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_podiel_priestoru_86f78e3c99.png"}',
      helptextFooterMarkdown: true,
    },
  )
...
const spoluvlastnickyPodiel = (typ: Typ) =>
  input(
    ...
    { type: 'ba-ratio', title: 'Spoluvlastnícky podiel', required: true },
    {
      ...
      helptextFooter:
        typ === Typ.Byt
          ? 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o mene vlastníkov. :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/6_byt_spoluvlastnicky_podiel_cf4b72f71b.png"}'
          : 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o mene vlastníkov. :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_spoluvlastnicky_podiel_79034be7a6.png"}',
      helptextFooterMarkdown: true,
    },
  )
                ...
                object('riadok', {}, [
                  ...
                  input(
                    ...
                    },
                    {
                      selfColumn: '2/4',
                      helptextFooter:
                        'Napr. číslo parkovacieho státia alebo pivničnej kobky (malo by byť uvedené aj na LV). :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_cislo_3d64bba380.png"}',
                      helptextFooterMarkdown: true,
                    },
                  ),
                ]),
