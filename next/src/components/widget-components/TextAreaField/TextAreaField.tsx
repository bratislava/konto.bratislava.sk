...
const TextAreaField = ({
  ...
  const containerStyle = cn(
    'flex resize-none flex-col overflow-hidden rounded-lg border border-gray-200 bg-gray-0 text-size-p-small-r caret-gray-700 focus:border-gray-700 focus:outline-hidden lg:text-size-p-small',
    {
