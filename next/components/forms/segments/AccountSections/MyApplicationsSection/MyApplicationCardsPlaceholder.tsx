...
const MyApplicationCardsPlaceholder = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="max-w-(--breakpoint-lg) m-auto mt-0 flex w-full flex-col justify-around rounded-lg border-0 border-gray-200 px-8 pt-0 md:px-16 lg:mt-8 lg:flex-row lg:border-2 lg:py-10">
