...
import MoneyServiceIcon from '@/src/assets/icons/city-bratislava/taxes-and-fees.svg'
import PoolServiceIcon from '@/src/assets/icons/education-sport/swimming-pool.svg'
import CompassServiceIcon from '@/src/assets/icons/environment-construction/spatial-planning.svg'
import BasketServiceIcon from '@/src/assets/icons/environment-construction/waste.svg'
      ...
      <Stack>
        <div className="scrollbar-hide flex gap-4 overflow-x-scroll">
          <ServiceCard
            ...
            linkProps={{ children: 'Prejsť na žiadosť', href: '#' }}
          />
          <ServiceCard
          ...
          <ServiceCard
            ...
            linkProps={{ children: 'Zaplatiť daň digitálne', href: '#' }}
          />
          <ServiceCard
            ...
            linkProps={{ children: 'Kúpiť lístok', href: '#' }}
          />
        </div>
      </Stack>
    </Wrapper>
