...
import BottomSheetMenuRow from '@/src/components/forms/segments/AccountSections/MyApplicationsSection/BottomSheetMenu/BottomSheetMenuRow'
  ...
  return (
    <>
      ...
      <ModalOverlay
        isOpen={isOpen}
        onOpenChange={setIsOpen}
        className="fixed top-0 left-0 z-50 h-[var(--visual-viewport-height)] w-screen outline-0 data-entering:animate-stepper-slide data-exiting:animate-stepper-slide-reverse"
        isDismissable
      >
        <Modal
          isDismissable
