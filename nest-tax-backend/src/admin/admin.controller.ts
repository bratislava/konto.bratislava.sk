...
export class AdminController {
  ...
  async loadDataFromNoris(
    ...
    return await this.adminService.loadDataFromNoris(taxType, year, birthNumbers)
  }
  ...
  async updateDataFromNoris(
    ...
    const { taxType, year, birthNumbers } = data
    return await this.adminService.updateDataFromNoris(taxType, year, birthNumbers)
  }
  ...
  async updateOverpaymentsFromNoris(
    ...
    return await this.adminService.updateOverpaymentsDataFromNorisByDateRange(data)
  }
