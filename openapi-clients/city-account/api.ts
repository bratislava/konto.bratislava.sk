...
export const OAuth2ApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @param {OAuth2ControllerAuthorizeResponseTypeEnum} responseType Response type. Must be \&quot;code\&quot; for Authorization Code flow. \&quot;token\&quot; (implicit grant) is not supported.
     ...
     * @param {string} codeChallenge Code challenge for PKCE (RFC 7636). Required - PKCE is mandatory for all clients
     * @param {OAuth2ControllerAuthorizeCodeChallengeMethodEnum} codeChallengeMethod Code challenge method for PKCE. Required - PKCE is mandatory for all clients
    ...
    oAuth2ControllerAuthorize: async (
      ...
      assertParamExists('oAuth2ControllerAuthorize', 'codeChallenge', codeChallenge)
      // verify required parameter 'codeChallengeMethod' is not null or undefined
      assertParamExists('oAuth2ControllerAuthorize', 'codeChallengeMethod', codeChallengeMethod)
...
export const TowingApiFactory = function (
  ...
  return {
    ...
    towingControllerGetPublicTowingByEcv(
      ...
      return localVarFp
        .towingControllerGetPublicTowingByEcv(ecv, towingSearchRequestDto, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export const UsersManipulationApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    userControllerUpsertUser: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
      const localVarPath = `/user/upsert`
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const UsersManipulationApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async userControllerUpsertUser(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['UsersManipulationApi.userControllerUpsertUser']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
...
export class UsersManipulationApi extends BaseAPI {
   ...
   * @throws {RequiredError}
   */
  public userControllerUpsertUser(options?: RawAxiosRequestConfig) {
    return UsersManipulationApiFp(this.configuration)
      .userControllerUpsertUser(options)
      .then((request) => request(this.axios, this.basePath))
  }
