...
-- CreateEnum
CREATE TYPE "FormError" AS ENUM ('NONE', 'RABBITMQ_MAX_TRIES', 'FILES_NOT_YET_SCANNED', 'UNABLE_TO_SCAN_FILES', 'INFECTED_FILES', 'NASES_SEND_ERROR', 'GINIS_SEND_ERROR');
