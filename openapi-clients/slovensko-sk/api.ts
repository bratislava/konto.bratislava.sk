 ...
 *
 * The version of the OpenAPI document: 3.8.2 (Komunitná verzia) 8.9.2 (Prémium verzia)
...
/**
 * @type ApiUpvsIdentityGet200Response
 */
export type ApiUpvsIdentityGet200Response = UpvsCorporateBody | UpvsNaturalPerson
...
export const DlhodobLoiskoApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    ...
    apiMdurzRecordsIdDelete: async (
      ...
      const localVarPath = `/api/mdurz/records/{id}`.replace('{id}', encodeURIComponent(String(id)))
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
      if (configuration) {
...
export const InformcieOPrihlsenomPouvateoviApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async apiUpvsIdentityGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiUpvsIdentityGet200Response>
    > {
...
export const InformcieOPrihlsenomPouvateoviApiFactory = function (
  ...
  return {
    ...
    apiUpvsIdentityGet(
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<ApiUpvsIdentityGet200Response> {
