...
exports.ziadostONajomBytuSharepointData = void 0;
const defaultColumnMapNajomneByvanie = {
    GinisID: {
        type: 'mag_number',
    },
    MenoZiadatela: {
...
const columnMapNajomneByvanieZiadatel = {
    GinisID: {
        type: 'mag_number',
    },
    KontaktovanyEmailom: {
...
const defaultColumnMapNajomneByvanieDieta = {
    GinisID: {
        type: 'mag_number',
    },
    Meno: {
...
const defaultColumnMapNajomneByvanieIniClenovia = {
    GinisID: {
        type: 'mag_number',
    },
    Meno: {
...
const getDefaultColumnMapNajomneByvanieDruhDruzkaManzelManzelka = (prefix) => {
    return {
        GinisID: {
            type: 'mag_number',
        },
...
exports.ziadostONajomBytuSharepointData = {
