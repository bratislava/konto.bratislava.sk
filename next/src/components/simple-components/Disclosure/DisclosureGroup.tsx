...
import {
  disclosureStyles,
  DisclosureVariant,
} from '@/src/components/simple-components/Disclosure/disclosureStyles'
import { DisclosureVariantContext } from '@/src/components/simple-components/Disclosure/DisclosureVariantContext'
