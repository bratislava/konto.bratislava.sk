...
const exampleForm: ExampleForm = {
  ...
  formData: {
    ...
    zahrada: {
      dovodyZalozenia:
        'Priestor je v súčasnosti nevyužívaný a zanedbaný. Komunitná záhrada by poskytla miesto pre miestnych obyvateľov na pestovanie rastlín a stretávanie sa.',
      suhlasKomunity:
        'Získali sme podporu od miestnych obyvateľov prostredníctvom petície a verejných stretnutí.',
      organizacnyTim:
        'Tím bude pozostávať z miestnych dobrovoľníkov, ktorí sa budú starať o záhradu a organizovať komunitné aktivity.',
      prevadzka:
        'Údržbu zelene budú zabezpečovať dobrovoľníci. Odpad bude separovaný a recyklovaný, pričom sa budeme snažiť o zero-waste režim.',
      inkluzivnost:
        'Projekt bude otvorený pre všetkých miestnych obyvateľov. Záujemcovia o záhradkárčenie budú vybraní na základe transparentného procesu.',
      financovanie:
