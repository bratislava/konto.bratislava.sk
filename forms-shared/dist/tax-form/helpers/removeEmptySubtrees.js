...
exports.removeEmptySubtrees = void 0;
/**
 ...
 * ```
 */
const removeEmptySubtrees = (objOrArrayOrValue) => {
    if (Array.isArray(objOrArrayOrValue)) {
        const newArray = objOrArrayOrValue
            .map((item) => (0, exports.removeEmptySubtrees)(item))
    ...
    if (typeof objOrArrayOrValue === 'object' &&
        ...
        const newEntries = Object.entries(objOrArrayOrValue)
            .map(([key, value]) => [key, (0, exports.removeEmptySubtrees)(value)])
            .filter(([, value]) => value != null);
...
exports.removeEmptySubtrees = removeEmptySubtrees;
