...
export const NavBar = ({
  ...
  return (
    <>
      <div className="hidden lg:block" ref={ref1}>
        <StatusBar />
      </div>
      {/* Desktop */}
      <div
        ...
        className={cx(
          className,
          'text-p2 sticky left-0 top-0 z-20 hidden items-center lg:block',
          'w-full bg-white shadow',
        )}
        ref={ref2}
      >
        <div className={cx('m-auto hidden h-[57px] max-w-screen-lg items-center gap-x-6 lg:flex')}>
          <Brand
      ...
      {/* Mobile */}
      <MobileNavBar menuItems={menuItems} sectionsList={sectionsList} onResize={onResize} />
    </>
  )
}
