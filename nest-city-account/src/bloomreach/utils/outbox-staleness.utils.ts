 ...
 */
export const BLOOMREACH_PROPAGATION_WINDOW_HOURS = 8

/**
 * Matches outbox entries that are still live (PENDING/PROCESSING) or were
 * COMPLETED recently enough that Bloomreach export may not reflect them yet.
 */
export function isLiveOrRecentlyCompleted(
  propagationWindowHours: number = BLOOMREACH_PROPAGATION_WINDOW_HOURS
