 ...
 * Based on bratislava.sk: https://github.com/bratislava/bratislava.sk/blob/766d5e520d06c1875e4468eea460e75785fe24be/next/src/components/common/Carousel/Carousel.tsx
 */
              ...
              <li
                ...
                className={cn(
                  'shrink-0 transform transition-all duration-200 first:pl-4 last:pr-4 lg:scroll-mx-2 lg:first:pl-0 lg:last:pr-0 [&>*:first-child]:h-full',
                  {
                    ...
                    // copied behaviour from Bratislava.sk had flaw hiding part of next card
                    'w-[calc(100%-3rem)] snap-center': visibleCount === 1,
