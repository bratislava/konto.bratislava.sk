import { Experimental_DefaultFormStateBehavior, GenericObjectType, RJSFSchema } from '@rjsf/utils';
 ...
 */
export declare const isFileMultipleSchema: (schema: RJSFSchema) => boolean;
/**
 ...
 */
export declare const baDefaultFormStateBehavior: Experimental_DefaultFormStateBehavior;
export declare const baGetDefaultFormState: (schema: RJSFSchema, formData: GenericObjectType, validatorRegistry: BaRjsfValidatorRegistry, rootSchema?: RJSFSchema) => any;
/**
 ...
 */
export declare const baGetDefaultFormStateStable: (schema: RJSFSchema, formData: GenericObjectType, validatorRegistry: BaRjsfValidatorRegistry, rootSchema?: RJSFSchema, maxIterations?: number) => any;
