...
export declare const oddiel2Xml: (data: TaxFormData) => {
    DanZPozemkov: {
        DanZPozemkovZaznam: {
            Obec: string;
            DruhyZmien: {
                DruhZmeny: import("../shared/esbsCiselniky").CiselnikType;
            };
            HodnotaPozemkuUrcenaZnalcom: boolean;
            ...
            Pozemky: {
                Pozemok: {
                    ...
                    DruhPozemku: import("../shared/esbsCiselniky").Ciselnik | undefined;
