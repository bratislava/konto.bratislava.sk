...
import { oddiel4Shared } from '../shared-mapping/oddiel4Shared'
...
export const oddiel4 = (data: TaxFormData) => {
  ...
  return generateCopies(mapping, (priznanie) => {
    ...
    return {
      ...
      '6_RodneCislo3': formatRodneCisloFirstPartPdf(
        priznanie.rodneCisloManzelaManzelky,
      ),
      '6_RodneCislo4': formatRodneCisloSecondPartPdf(
        priznanie.rodneCisloManzelaManzelky,
      ),
      ...
      '6_DatumVzniku': formatDatePdf(
        priznanie.byt?.datumVznikuDanovejPovinnosti,
      ),
      '6_DatumZaniku': formatDatePdf(
        priznanie.byt?.datumZanikuDanovejPovinnosti,
      ),
      '6_ZDBytu': formatIntegerPdf(priznanie.byt?.zakladDane),
      '6_Vymera': formatIntegerPdf(
