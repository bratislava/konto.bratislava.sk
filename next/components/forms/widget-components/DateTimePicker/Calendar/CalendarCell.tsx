  ...
  return (
    <div {...cellProps}>
      <div
        ...
        ref={ref}
        className={cx(
          'text-p2-medium xs:h-10 xs:w-10 flex h-8 w-8 items-center justify-center focus:rounded-lg focus:bg-gray-700 focus:text-white focus-visible:outline-hidden',
          {
