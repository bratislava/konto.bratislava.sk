 ...
 */
export declare const markdownTextPrefix = "markdown_gKgflRNwdS:";
export declare enum BaWidgetType {
    Select = "Select",
...
export declare enum BaFieldType {
