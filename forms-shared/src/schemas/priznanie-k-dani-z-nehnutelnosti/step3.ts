...
const celkovaVymeraPozemku = number(
  ...
  {
    helptextFooter:
      'Zadávajte číslo, nachádza sa ako 2. v poradí v tabuľke na LV. Pozemky pod stavbami sa nezdaňujú. Sčítate len tie, ktoré majú iný kód využitia ako “15”. :form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemok_celkova_vymera_67d9f26e23.png"}',
...
const podielPriestoruNaSpolocnychCastiachAZariadeniachDomu = input(
  ...
  },
  {
    ...
    helptextFooter:
      'Zadávajte celý zlomok. Nájdete ho vedľa údajov o vchode, poschodí a čísle bytu. Ak ho nemáte, zadajte 1/1. :form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemok_podiel_priestoru_2446155a08.png"}',
    helptextFooterMarkdown: true,
  },
)
...
const spoluvlastnickyPodiel = input(
  ...
  { type: 'ba-ratio', title: 'Spoluvlastnícky podiel', required: true },
  {
    ...
    helptextFooter:
      'Zadávajte celý zlomok. Nájdete ho vedľa údajov o mene vlastníkov. :form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemok_spoluvlastnicky_podiel_a8753d1b69.png"}',
    helptextFooterMarkdown: true,
  },
)
    ...
    [
      ...
      arrayField(
        ...
        { title: 'Pozemky', required: true, maxItems: 17 },
        {
          ...
          description:
            'Pozemky pod stavbami, v ktorej máte nehnuteľnosť, sa nezdaňujú.\n\n:form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemky_c16049c4bd.png"}',
        ...
        [
          ...
          object('parcelneCisloSposobVyuzitiaPozemku', {}, [
            input(
              ...
              { type: 'text', title: 'Číslo parcely', required: true },
              {
                ...
                helptextFooter:
                  'Zadávajte číslo s lomítkom. Nachádza sa na LV ako parcelné číslo. :form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemok_cislo_parcely_d88349308a.png"}',
                helptextFooterMarkdown: true,
              },
            ),
            input(
          ...
          select(
            ...
            {
              helptextFooter:
                'V prípade, že máte vydané právoplatné stavebné povolenie na stavbu vyberte možnosť G - Stavebné pozemky. :form-image-preview[Zobraziť ukážku]{src="https://s3.bratislava.sk/general-strapi/upload/3_pozemky_druh_pozemku_dea5055c20.png"}',
              helptextFooterMarkdown: true,
            },
          ),
