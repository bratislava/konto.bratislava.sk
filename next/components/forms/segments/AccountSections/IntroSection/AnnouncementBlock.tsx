...
const AnnouncementBlock = ({
  ...
  return announcementContent ? (
    <div className="mb-6 lg:mb-16 px-4 lg:px-0">
      ...
      <div className="w-full border-2 border-gray-200 rounded-lg lg:rounded-3xl flex flex-col-reverse lg:flex-row gap-8">
        <div className="w-full lg:w-1/2 flex flex-col justify-center gap-4 lg:gap-6 p-4 lg:p-12 lg:pr-14">
