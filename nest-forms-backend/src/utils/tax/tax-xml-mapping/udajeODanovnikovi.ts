...
export const udajeODanovnikoviXml = (data: TaxFormData) => {
  ...
  return {
    ...
    Danovnik: {
      ...
      IdentifikaciaOsoby: {
        TitulyPredMenom: titul?.predMenom
          ? { TitulPredMenom: titul.predMenom }
          : undefined,
        Meno: mapping.meno,
        Priezvisko: mapping.priezvisko,
        // RodnePriezvisko
        // MestskaCast
        TitulyZaMenom: titul?.zaMenom
          ? { TitulZaMenom: titul.zaMenom }
          : undefined,
        ...
        // PriezviskoZastupcu
        ICO: mapping.ico,
        PravnaForma: getCiselnikEntryByCode(
          esbsPravnaFormaCiselnik,
          mapping.pravnaForma,
        ),
      },
    ...
    OpravnenaOsoba: {
      ...
      AdresaOpravnenejOsoby: {
        ...
        Stat: getCiselnikEntryByCode(
          esbsNationalityCiselnik,
          mapping.splnomocnenecStat,
        ),
      },
