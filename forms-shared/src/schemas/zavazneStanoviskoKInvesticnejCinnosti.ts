...
const extractGinisSubjectFormDataSchema = {
  type: 'object',
  required: ['stavba'],
  properties: {
    stavba: {
...
export const zavazneStanoviskoKInvesticnejCinnostiExtractGinisSubject =
  createFormDataExtractor<ExtractGinisSubjectFormData>(
    extractGinisSubjectFormDataSchema,
    (formData) => {
...
export const zavazneStanoviskoKInvesticnejCinnostiExtractSubject =
