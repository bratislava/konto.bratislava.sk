...
export default async function e2eGlobalTeardown(): Promise<void> {
  ...
  if (postgresContainer) {
    // CI currently fails to reconnect to Docker during Jest globalTeardown on the runner,
    // even though the E2E tests themselves pass. Keep this commented out there until
