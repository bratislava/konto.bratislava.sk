...
export const oddielBaseShared = (
  ...
  isNajomca:
    !isBytyANebytovePriestory && priznanie.pravnyVztah === PravnyVztah.Najomca,
  isUzivatel:
    !isBytyANebytovePriestory && priznanie.pravnyVztah === PravnyVztah.Uzivatel,
  isPodieloveSpoluvlastnictvo:
    priznanie.spoluvlastnictvo === Spoluvlastnictvo.Podielove,
  isBezpodieloveSpoluvlastnictvo:
