...
const celkovaZastavanaPlocha = number(
  ...
  {
    helptextFooter:
      'Uveďte výmeru zastavanej plochy pozemku/ov, na ktorom je umiestnená stavba. Nájdete ju na LV, v časti A. (druh pozemku - zastavaná plocha a nádvorie). :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/4_stavba_celkova_zastavana_plocha_5dac588a12.png"}',
...
const spoluvlastnickyPodiel = input(
  ...
  },
  {
    ...
    helptextFooter:
      'Nájdete ho na LV, časti B, vedľa údajov o vlastníkovi. Zadávajte celý zlomok. :form-image-preview[Zobraziť ukážku]{src="https://general-strapi.s3.bratislava.sk/upload/4_stavba_spoluvlastnicky_podiel_41513cd88b.png"}',
    helptextFooterMarkdown: true,
  },
)
