...
export const serviceCards: ServiceCardBase[] = [
  {
    ...
    icon: <TaxesIcon className="text-main-600 size-10 lg:size-12" />,
...

  {
    ...
    icon: <TransportIcon className="text-transport-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <ParkingIcon className="text-transport-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.TRANSPORT_CATEGORY],
  ...
  },
  {
    ...
    icon: <LibraryIcon className="text-culture-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <TowIcon className="text-transport-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.TRANSPORT_CATEGORY],
  ...
  },
  {
    ...
    icon: <KidIcon className="text-main-600 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <TreeIcon className="text-environment-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <GardensIcon className="text-environment-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <TheatreIcon className="text-culture-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.CULTURE_CATEGORY],
  ...
  },
  {
    ...
    icon: <ExcavationsIcon className="text-transport-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <SecurityIcon className="text-main-600 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <ZooIcon className="text-culture-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.CULTURE_CATEGORY],
  ...
  },
  {
    ...
    icon: <MosquitoIcon className="text-environment-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.JOIN_CATEGORY],
  ...
  },
  {
    ...
    icon: <ChristmasTreeIcon className="text-environment-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <FrontGardensIcon className="text-environment-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <BasketIcon className="text-environment-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.BASKET_CATEGORY],
  ...
  },
  {
    ...
    icon: <AdministrationIcon className="text-main-600 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <SewerageIcon className="text-environment-700 size-10 lg:size-12" />,
  ...
  },
  {
    ...
    icon: <SwimmingPoolIcon className="text-education-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.CULTURE_CATEGORY],
  ...
  },
  {
    ...
    icon: <CulturalOrganizationIcon className="text-culture-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.CULTURE_CATEGORY],
  ...
  },
  {
    ...
    icon: <SpatialPlanningIcon className="text-environment-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.CONSTRUCTION_CATEGORY],
  ...
  },
  {
    ...
    icon: <PublicSpaceOccupationIcon className="text-main-600 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.PUBLIC_SPACE_CATEGORY],
  ...
  },
  {
    ...
    icon: <ManagmentCommunicationsIcon className="text-transport-700 size-10 lg:size-12" />,
    category: [MunicipalServicesCategories.TRANSPORT_CATEGORY],
  ...
  },
  {
    ...
    icon: <HousingIcon className="text-social-600 size-10 lg:size-12" />,
