 ...
 * @export
 */
export type ApiIamIdentitiesIdGet200Response =
  | UpvsCorporateBody
  | UpvsNaturalPerson
...
export type UpvsIdentityTypeEnum =
  (typeof UpvsIdentityTypeEnum)[keyof typeof UpvsIdentityTypeEnum]
 ...
 * @export
 */
export const CentrlnaRadnTabuaDostupnLenPreOVMApiFp = function (
  configuration?: Configuration,
) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCuetDocumentsIdPatch(
          id,
          requestId,
          revocationReason,
          revokedOn,
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'CentrlnaRadnTabuaDostupnLenPreOVMApi.apiCuetDocumentsIdPatch'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCuetDocumentsPublishDocumentPost(
          requestId,
          publisherUri,
          authorUri,
          name,
 ...
 * @export
 */
export const DlhodobLoiskoApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const DlhodobLoiskoApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    DlhodobLoiskoApiAxiosParamCreator(configuration)
  return {
    /**
     * Odošle požiadavku na vyradenie záznamu z úložiska. Do schránky príde odpoveď s SKTalk triedou `MDURZ_CANCEL_PRESERVATION_REPLY_04` obsahujúca uložený záznam. Voči zaslanej požiadavke je možné párovanie cez poskytnutý `request_id`.  Volanie automaticky validuje, či je interne používaná správna verzia formulára. Nie je potrebné kontrolovať validitu formulára externe.
     * @summary Vyradí záznam z úložiska
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiMdurzRecordsIdDelete(
          id,
          requestId,
          destination,
          apiMdurzRecordsIdDeleteRequest,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiMdurzRecordsIdDisseminatePost(
          id,
          requestId,
          destination,
          apiMdurzRecordsIdDeleteRequest,
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'DlhodobLoiskoApi.apiMdurzRecordsIdDisseminatePost'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiMdurzRecordsIdExtendPatch(
          id,
          requestId,
          retentionPeriod,
          apiMdurzRecordsIdDeleteRequest,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiMdurzRecordsIdPatch(
          id,
          requestId,
          customId,
          title,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiMdurzRecordsPost(
          requestId,
          customId,
          title,
          description,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DlhodobLoiskoApi.apiMdurzRecordsPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const InformcieOPrihlsenomPouvateoviApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiUpvsAssertionGet(accept, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'InformcieOPrihlsenomPouvateoviApi.apiUpvsAssertionGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async apiUpvsIdentityGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UpvsNaturalPerson>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiUpvsIdentityGet(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'InformcieOPrihlsenomPouvateoviApi.apiUpvsIdentityGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const ManamentAutentifikanchCertifiktovAdministrciaApiAxiosParamCreator =
...
export const ManamentAutentifikanchCertifiktovAdministrciaApiFp = function (
  ...
  const localVarAxiosParamCreator =
    ManamentAutentifikanchCertifiktovAdministrciaApiAxiosParamCreator(
      configuration,
    )
  return {
    /**
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.administrationCertificatesIdDelete(
          id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.administrationCertificatesIdGet(
          id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.administrationCertificatesPost(
          administrationCertificatesPostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
 ...
 * @export
 */
export const ManamentAutentifikanchCertifiktovAdministrciaApiFactory =
  function (
    configuration?: Configuration,
    basePath?: string,
    axios?: AxiosInstance,
    ...
    const localVarFp =
      ManamentAutentifikanchCertifiktovAdministrciaApiFp(configuration)
    return {
      /**
       *
       * @summary Zmaže certifikát
...
export class ManamentAutentifikanchCertifiktovAdministrciaApi extends BaseAPI {
   ...
   */
  public administrationCertificatesIdDelete(
    id: string,
    options?: RawAxiosRequestConfig,
  ) {
    return ManamentAutentifikanchCertifiktovAdministrciaApiFp(
      this.configuration,
    )
      .administrationCertificatesIdDelete(id, options)
      .then((request) => request(this.axios, this.basePath))
   ...
   * @memberof ManamentAutentifikanchCertifiktovAdministrciaApi
   */
  public administrationCertificatesIdGet(
    id: string,
    options?: RawAxiosRequestConfig,
  ) {
    return ManamentAutentifikanchCertifiktovAdministrciaApiFp(
 ...
 * @export
 */
export const ManipulciaSoSchrnkouApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
 ...
 * @export
 */
export const ManipulciaSoSchrnkouApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    ManipulciaSoSchrnkouApiAxiosParamCreator(configuration)
  return {
    /**
     * Vráti zoznam priečinkov v schránke.
     * @summary Vráti zoznam priečinkov v schránke
    ...
    async apiEdeskFoldersGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<EdeskFolder>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskFoldersGet(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskFoldersIdMessagesGet(
          id,
          page,
          perPage,
          options,
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ManipulciaSoSchrnkouApi.apiEdeskFoldersIdMessagesGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskMessagesIdAuthorizePost(
          id,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ManipulciaSoSchrnkouApi.apiEdeskMessagesIdAuthorizePost'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskMessagesIdDelete(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ManipulciaSoSchrnkouApi.apiEdeskMessagesIdDelete'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async apiEdeskMessagesIdGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<EdeskMessage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskMessagesIdGet(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskMessagesIdPatch(
          id,
          apiEdeskMessagesIdPatchRequest,
          options,
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEdeskMessagesSearchGet(
          correlationId,
          page,
          perPage,
          options,
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ManipulciaSoSchrnkouApi.apiEdeskMessagesSearchGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export class ManipulciaSoSchrnkouApi extends BaseAPI {
   ...
   * @memberof ManipulciaSoSchrnkouApi
   */
  public apiEdeskMessagesIdAuthorizePost(
    id: number,
    options?: RawAxiosRequestConfig,
  ) {
    return ManipulciaSoSchrnkouApiFp(this.configuration)
 ...
 * @export
 */
export const PodpisovanieApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const PodpisovanieApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    PodpisovanieApiAxiosParamCreator(configuration)
  return {
    /**
     * Rozšíri digitálny podpis z EPES na T formu pridaním kvalifikovanej časovej pečiatky.
     * @summary Pridá kvalifikovanú časovú pečiatku.
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCepAddTimestampPost(
          apiCepAddTimestampPostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PodpisovanieApi.apiCepAddTimestampPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PodpisovanieApi.apiCepSignPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCepSignV2Post(
          apiCepSignV2PostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PodpisovanieApi.apiCepSignV2Post']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCepSignaturesInfoPost(
          apiCepSignaturesInfoPostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCepVerifyPost(
          apiCepVerifyPostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PodpisovanieApi.apiCepVerifyPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const PrihlasovaniePomocouEIDApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    PrihlasovaniePomocouEIDApiAxiosParamCreator(configuration)
  return {
    /**
     * Prihlási používateľa pomocou slovensko.sk (ÚPVS).  Po úspešnom prihlásení nasleduje presmerovanie späť na callback URL tretej strany nastavený v premenných prostredia API (LOGIN_CALLBACK_URL).  V parametri `token` bude zaslaný OBO (On-Behalf-Of) token použiteľný na získanie údajov o prihlásenom používateľovi alebo na volanie ďaľších rozhraní v mene prihláseného používateľa.
     * @summary Prihlási používateľa pomocou eID
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.loginGet(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PrihlasovaniePomocouEIDApi.loginGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PrihlasovaniePomocouEIDApi.loginPost']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.logoutGet(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['PrihlasovaniePomocouEIDApi.logoutGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const StavKomponentuMonitoringApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    StavKomponentuMonitoringApiAxiosParamCreator(configuration)
  return {
    /**
     *
     * @summary Vráti stav komponentu
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['StavKomponentuMonitoringApi.healthGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const UniverzlneSynchrnneRozhranieSluiebPVSApiAxiosParamCreator =
  function (configuration?: Configuration) {
    return {
      /**
 ...
 * @export
 */
export const UniverzlneSynchrnneRozhranieSluiebPVSApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'UniverzlneSynchrnneRozhranieSluiebPVSApi.apiUsrPost'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const VyhadvanieIdenttDostupnLenPreOVMApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiIamIdentitiesIdGet(id, options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'VyhadvanieIdenttDostupnLenPreOVMApi.apiIamIdentitiesIdGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiIamIdentitiesSearchPost(
          apiIamIdentitiesSearchPostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'VyhadvanieIdenttDostupnLenPreOVMApi.apiIamIdentitiesSearchPost'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const ZasielaniePodanApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const ZasielaniePodanApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ZasielaniePodanApiAxiosParamCreator(configuration)
  return {
    /**
     * Vráti dokument súvisiaci s formulárom. Napr. XSD schému, XSLT transformáciu.
     * @summary Vráti dokument súvisiaci s formulárom
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ZasielaniePodanApi.apiEformFormTemplateRelatedDocumentGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEformStatusGet(
          identifier,
          version,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['ZasielaniePodanApi.apiEformStatusGet']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiEformValidatePost(
          identifier,
          version,
          apiEformValidatePostRequest,
          options,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiSktalkPrepareForLaterReceiveGet(
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ZasielaniePodanApi.apiSktalkPrepareForLaterReceiveGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiSktalkReceiveAndSaveToOutboxPost(
          apiSktalkReceivePostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ZasielaniePodanApi.apiSktalkReceiveAndSaveToOutboxPost'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiSktalkReceivePost(
          apiSktalkReceivePostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiSktalkSaveToOutboxPost(
          apiSktalkReceivePostRequest,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
 ...
 * @export
 */
export const ZasielaniePodanAdministrciaApiFp = function (
  configuration?: Configuration,
) {
  const localVarAxiosParamCreator =
    ZasielaniePodanAdministrciaApiAxiosParamCreator(configuration)
  return {
    /**
     * Spustí manuálnu aktualizáciu lokálneho úložiska všetkých formulárov. Za normálnych okolností sa spúšťa automaticky a nie je ho potrebné spúštať manuálne.
     * @summary Spustí synchronizáciu formulárov
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.administrationEformSynchronizeGet(
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ZasielaniePodanAdministrciaApi.administrationEformSynchronizeGet'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
