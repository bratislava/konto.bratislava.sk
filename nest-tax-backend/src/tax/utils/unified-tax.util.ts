...
const createHolidayYear = (year: number, dateStrings: string[]) => ({
  year,
  dates: dateStrings.map(dateStr => dayjs.tz(dateStr, bratislavaTimeZone))
})
