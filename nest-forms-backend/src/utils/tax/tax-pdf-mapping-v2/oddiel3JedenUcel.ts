...
import { oddiel3JedenUcelShared } from '../shared-mapping/oddiel3JedenUcelShared'
...
export const oddiel3JedenUcel = (data: TaxFormData) => {
  ...
  return generateCopies(mapping, (priznanie) => ({
    ...
    '4_RodneCislo3': formatRodneCisloFirstPartPdf(
      priznanie.rodneCisloManzelaManzelky,
    ),
    '4_RodneCislo4': formatRodneCisloSecondPartPdf(
      priznanie.rodneCisloManzelaManzelky,
    ),
