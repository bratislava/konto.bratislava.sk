...
import ForgottenPasswordForm from '@/src/components/forms/auth-forms/ForgottenPasswordForm'
import NewPasswordForm from '@/src/components/forms/auth-forms/NewPasswordForm'
