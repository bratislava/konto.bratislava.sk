BEGIN;
UPDATE "Forms" SET "state" = 'ERROR' WHERE "state" = 'ERROR_USER_CAN_REPAIR';
CREATE TYPE "FormState_new" AS ENUM ('DRAFT', 'QUEUED', 'SENDING_TO_NASES', 'DELIVERED_NASES', 'DELIVERED_GINIS', 'PROCESSING', 'FINISHED', 'REJECTED', 'ERROR');
