...
const podielPriestoruNaSpolocnychCastiachAZariadeniachDomu = (typ: Typ) =>
  input(
    ...
    },
    {
      ...
      helptextFooter:
        typ === Typ.Byt
          ? 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o vchode, poschodí a čísle bytu. :form-image-preview[Zobraziť ukážku]{src="https://city-account-strapi.s3.bratislava.sk/upload/6_byt_podiel_priestoru_5400bc2180.png"}'
          : 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o vchode, poschodí a čísle priestoru. :form-image-preview[Zobraziť ukážku]{src="https://city-account-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_podiel_priestoru_e84e0c5dae.png"}',
      helptextFooterMarkdown: true,
    },
  )
...
const spoluvlastnickyPodiel = (typ: Typ) =>
  input(
    ...
    { type: 'ba-ratio', title: 'Spoluvlastnícky podiel', required: true },
    {
      ...
      helptextFooter:
        typ === Typ.Byt
          ? 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o mene vlastníkov. :form-image-preview[Zobraziť ukážku]{src="https://city-account-strapi.s3.bratislava.sk/upload/6_byt_spoluvlastnicky_podiel_b5ff8a69eb.png"}'
          : 'Zadávajte celý zlomok. Nájdete ho vedľa údajov o mene vlastníkov. :form-image-preview[Zobraziť ukážku]{src="https://city-account-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_spoluvlastnicky_podiel_254472bedc.png"}',
      helptextFooterMarkdown: true,
    },
  )
                ...
                object('riadok', {}, [
                  ...
                  input(
                    ...
                    },
                    {
                      selfColumn: '2/4',
                      helptextFooter:
                        'Napr. číslo parkovacieho státia alebo pivničnej kobky (malo by byť uvedené aj na LV). :form-image-preview[Zobraziť ukážku]{src="https://city-account-strapi.s3.bratislava.sk/upload/6_nebytovypriestor_cislo_5fe531079c.png"}',
                      helptextFooterMarkdown: true,
                    },
                  ),
                ]),
