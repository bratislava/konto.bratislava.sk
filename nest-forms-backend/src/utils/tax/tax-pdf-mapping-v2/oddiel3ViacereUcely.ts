...
import { oddiel3ViacereUcelyShared } from '../shared-mapping/oddiel3ViacereUcelyShared'
...
export const oddiel3ViacereUcely = (data: TaxFormData) => {
  ...
  return generateCopies(mapping, (priznanie) => {
    ...
    return {
      ...
      '5_RodneCislo3': formatRodneCisloFirstPartPdf(
        priznanie.rodneCisloManzelaManzelky,
      ),
      '5_RodneCislo4': formatRodneCisloSecondPartPdf(
        priznanie.rodneCisloManzelaManzelky,
      ),
