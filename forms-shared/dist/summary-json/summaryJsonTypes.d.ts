...
export declare enum SummaryJsonType {
    Form = "Form",
    Step = "Step",
    Field = "Field",
    Array = "Array",
...
export type SummaryJsonElement = SummaryJsonForm | SummaryJsonStep | SummaryJsonField | SummaryJsonArray | SummaryJsonArrayItem;
