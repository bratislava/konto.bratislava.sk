...
const useInitialModal = () => {
  ...
  if (
    evaluatedSendPolicy.send.allowedForUserResult ===
      SendAllowedForUserResult.AuthenticationMissing ||
    evaluatedSendPolicy.send.allowedForUserResult ===
      SendAllowedForUserResult.AuthenticationAndVerificationMissing
  ) {
    return InitialModal.Registration
  }

  if (
    evaluatedSendPolicy.send.allowedForUserResult === SendAllowedForUserResult.VerificationMissing
  ) {
