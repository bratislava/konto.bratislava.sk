...
describe('MailgunService', () => {
  ...
  describe('sendEmail', () => {
    ...
    it('should send delivery method changed email with EDESK type', async () => {
      const options = {
        to: 'test@example.com',
        variables: {
          firstName: 'Alice',
          year: '2025',
          deliveryMethod: 'edesk' as const,
        },
      }
    ...
    it('should send delivery method changed email with POSTAL type', async () => {
      const options = {
        to: 'test@example.com',
        variables: {
          firstName: 'Charlie',
    ...
    it('should send delivery method changed email with EMAIL type and attachment', async () => {
