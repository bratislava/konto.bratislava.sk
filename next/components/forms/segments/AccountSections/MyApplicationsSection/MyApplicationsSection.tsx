  ...
  return (
    ...
    >
      <div className="bg-gray-50 pl-8 lg:pl-0">
        <div className="max-w-(--breakpoint-lg) m-auto size-full flex-col justify-end gap-4 pt-6 lg:gap-6 lg:pt-14">
          <h1 className="text-h1 pt-4">{title}</h1>
          <TabList className="scrollbar-hide max-w-(--breakpoint-lg) flex gap-4 overflow-auto whitespace-nowrap pt-6 lg:gap-6 lg:pt-14">
            {headerNavigationList.map((item) => {
              ...
              return (
                <Tab
                  ...
                  className="text-20 hover:text-20-semibold data-selected:text-20-semibold before:text-20-semibold data-selected:border-b-2 data-selected:border-gray-700 cursor-pointer py-4 text-center transition-all before:invisible before:block before:h-0 before:overflow-hidden before:content-[attr(data-before-text)] hover:border-gray-700"
                >
                  {text}
                </Tab>
              )
