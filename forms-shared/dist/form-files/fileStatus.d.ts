export declare enum FileStatusType {
...
export declare const isDoneFileStatusType: (status: FileStatusType) => boolean;
export declare const isUploadFileStatusType: (status: FileStatusType) => boolean;
export declare const isScanFileStatusType: (status: FileStatusType) => boolean;
export declare const isErrorFileStatusType: (status: FileStatusType) => boolean;
export declare const isInfectedFileStatusType: (status: FileStatusType) => boolean;
export declare const isDownloadableFileStatusType: (status: FileStatusType) => boolean;
export declare enum UploadClientErrorReasonType {
    LargeFile = "LargeFile",
...
export type FileStatus = {
    ...
    type: FileStatusType.UnknownStatus;
    offline: boolean;
} | {
