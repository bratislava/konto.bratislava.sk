...
const MunicipalServicesSection = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      <div className="max-w-(--breakpoint-lg) mx-auto w-full pt-4 lg:pt-8">
        <h2 className="sr-only">{t('account_section_services.services_list')}</h2>
        <div className="grid grid-cols-1 gap-3 px-4 min-[615px]:grid-cols-2 sm:gap-6 md:gap-8 min-[960px]:grid-cols-3 lg:grid-cols-4 lg:px-0">
