...
export const udajeODanovnikoviShared = (data: TaxFormData) => {
  ...
  const splnomocnenecFyzickaOsobaFields = splnomocnenecFyzickaOsoba
    ? {
        ...
        splnomocnenecTitul: safeString(
          oddiel?.opravnenaOsoba?.menoTitul?.titul,
        ),
  ...
  const pravnickaOsobaNieVoSvojomMeneFields = pravnickaOsobaNieVoSvojomMene
    ? {
        ...
        splnomocnenecZastupca:
          oddiel?.pravnyVztahKPO === PravnyVztahKPO.Zastupca,
  ...
  return {
    ...
    isCiastkovePriznanie:
      druhPriznania?.druh === DruhPriznaniaEnum.CiastkovePriznanie,
    isCiastkovePriznanieNaZanikDanovejPovinnosti:
      druhPriznania?.druh ===
      DruhPriznaniaEnum.CiastkovePriznanieNaZanikDanovejPovinnosti,
    isOpravnePriznanie:
      druhPriznania?.druh === DruhPriznaniaEnum.OpravnePriznanie,
    isDodatocnePriznanie:
      druhPriznania?.druh === DruhPriznaniaEnum.DodatocnePriznanie,
