...
export type GdprDataDtoTypeEnum =
  (typeof GdprDataDtoTypeEnum)[keyof typeof GdprDataDtoTypeEnum]
...
export const ResponseCustomErrorVerificationEidDtoErrorNameEnum = {
  ...
  BirthNumberAndIdentityCardInconsistency:
...
export const ADMINApiAxiosParamCreator = function (
  ...
  return {
    ...
    adminControllerGetVerificationDataForUser: async (
      ...
      const localVarPath =
        `/admin/user/id-card-verification-data/{email}`.replace(
          `{${'email'}}`,
          encodeURIComponent(String(email)),
        )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminControllerCheckUserVerifyState(
          email,
          options,
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminControllerDeactivateAccount(
          externalId,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ADMINApi.adminControllerGetUserDataByBirthNumber'
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ADMINApi.adminControllerGetUserDataByBirthNumbersBatch'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminControllerGetVerificationDataForUser(
          email,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ADMINApi.adminControllerGetVerificationDataForUser'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'ADMINApi.adminControllerValidatePhysicalEntityRfo'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminControllerValidatedUsersToPhysicalEntities(
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'ADMINApi.adminControllerValidatedUsersToPhysicalEntities'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async adminControllerVerifyUserManually(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OnlySuccessDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.adminControllerVerifyUserManually(
          email,
          manuallyVerifyUserRequestDto,
          options,
        )
...
export class ADMINApi extends BaseAPI {
   ...
   * @memberof ADMINApi
   */
  public adminControllerCheckUserVerifyState(
    email: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof ADMINApi
   */
  public adminControllerDeactivateAccount(
    externalId: string,
    options?: RawAxiosRequestConfig,
  ) {
    return ADMINApiFp(this.configuration)
   ...
   * @memberof ADMINApi
   */
  public adminControllerGetVerificationDataForUser(
    email: string,
    options?: RawAxiosRequestConfig,
  ) {
    return ADMINApiFp(this.configuration)
   ...
   * @memberof ADMINApi
   */
  public adminControllerValidatedUsersToPhysicalEntities(
    options?: RawAxiosRequestConfig,
  ) {
    return ADMINApiFp(this.configuration)
      .adminControllerValidatedUsersToPhysicalEntities(options)
  ...
  return {
    ...
    async authControllerLogin(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CognitoGetUserData>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.authControllerLogin(options)
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap['DefaultApi.appControllerHealthCheck']?.[
          localVarOperationServerIndex
        ]?.url
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const UserVerificationsApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const UserVerificationsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    UserVerificationsApiAxiosParamCreator(configuration)
  return {
    /**
     * This endpoint return all user data in database of city account and his gdpr latest gdpr data. Null in gdpr means is not subscribe neither unsubscribe. If this endpoint will create user, create automatically License subscription.
     * @summary Get or create user with his data
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.verificationControllerVerifyWithEid(
          requestBodyVerifyWithEidDto,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'UserVerificationsApi.verificationControllerVerifyWithEid'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const UsersManipulationApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const UsersManipulationApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    UsersManipulationApiAxiosParamCreator(configuration)
  return {
    /**
     * Change email saved in database for a given cognito user.
     * @summary Change email of cognito user in database
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerChangeEmail(
          changeEmailRequestDto,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'UsersManipulationApi.userControllerGetOrCreateUser'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'UsersManipulationApi.userControllerRemoveBirthNumber'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerSubscribeLoggedUser(
          requestGdprDataDto,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'UsersManipulationApi.userControllerSubscribeLoggedUser'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerUnsubscribeLoggedUser(
          requestGdprDataDto,
          options,
        )
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0
      const localVarOperationServerBasePath =
        operationServerMap[
          'UsersManipulationApi.userControllerUnsubscribeLoggedUser'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userControllerUnsubscribePublicUser(
          id,
          type,
          category,
          options,
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'UsersManipulationApi.userControllerUnsubscribePublicUser'
        ]?.[localVarOperationServerIndex]?.url
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
