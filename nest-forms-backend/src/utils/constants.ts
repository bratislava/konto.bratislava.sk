...
// TODO save xsd and xslt to db, use them here
// MedzinarodneVolacieCislo and email validation different than in the original http://schemas.gov.sk/form/esmao.eforms.bratislava.obec_024/201501.2 xsd
// the original has incorrect regex format, we've removed the validation here
export const TAX_XSD = `<?xml version="1.0" encoding="utf-8"?>
...
export const TAX_XSLT = `<?xml version="1.0" encoding="utf-8" standalone="yes"?>
...
export const SIGNER_EXAMPLE_PAYLOAD = {
  objectId: '',
  objectDescription: '',
  objectFormatIdentifier: '',
  xdcXMLData: XML_FORM_EXAMPLE,
