...
const StepperModal = ({ isOpen, setIsOpen, handleOnSkipToStep }: StepperModalProps) => {
  ...
  return (
    <ModalOverlay
      ...
      className="data-entering:animate-stepper-slide data-exiting:animate-stepper-slide-reverse fixed top-0 left-0 z-50 h-[var(--visual-viewport-height)] w-screen bg-white outline-0"
      isDismissable
    >
