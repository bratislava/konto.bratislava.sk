...
test('neoverený používateľ vidí upozornenie a prejde na overenie identity', async ({ page }) => {
...
test('súhlas so zasielaním informácií sa dá zapnúť a vypnúť', async ({ page }) => {
...
test('zmena mena a priezviska sa uloží', async ({ page, registeredAccount }) => {
