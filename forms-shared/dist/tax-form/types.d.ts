...
export type Kataster = 'Čunovo' | 'Devín' | 'Devínska Nová Ves' | 'Dúbravka' | 'Jarovce' | 'Karlova Ves' | 'Lamač' | 'Nivy' | 'Nové Mesto' | 'Petržalka' | 'Podunajské Biskupice' | 'Rača' | 'Rusovce' | 'Ružinov' | 'Staré Mesto' | 'Trnávka' | 'Vajnory' | 'Vinohrady' | 'Vrakuňa' | 'Záhorská Bystrica';
export type Riadok2 = {
    kataster?: Kataster;
    cisloParcely?: string;
};
...
export declare enum SplonomocnenecTyp {
...
export declare enum PriznanieAko {
    FyzickaOsoba = "fyzickaOsoba",
    FyzickaOsobaPodnikatel = "fyzickaOsobaPodnikatel",
    PravnickaOsoba = "pravnickaOsoba"
}
export declare enum PravnyVztahKPO {
...
export declare enum DruhPriznaniaEnum {
    Priznanie = "priznanie",
...
export declare enum PravnyVztah {
    Vlastnik = "vlastnik",
    Spravca = "spravca",
    Najomca = "najomca",
    Uzivatel = "uzivatel"
}
export declare enum Spoluvlastnictvo {
